...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el país del atleta");
	...
	{
		System.out.println("País de un atleta");
		String atleta = input("Por favor ingrese el nombre del atleta");
		String Elpais = calculadora.PaisDeAtleta(atleta);
		if (Elpais == null)
		{
		...
		{
			System.out.println("El país de este atleta es: " + Elpais);
		}
